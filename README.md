...
![没有添加过支付的直接跳过](assets/04-没有添加过支付的直接跳过.png)

如果之前绑过支付方式，需要往下翻到**支付资料状态**那一栏，能看到一个关闭支付资料的红色入口，点击它。

![有添加过付款的点击关闭支付资料](assets/05-有添加过付款的点击关闭支付资料.png)

点了之后系统会弹一个确认框，让你选关闭的理由，**随便选一个就行**，比如那个我刚刚发现自己有付款资料但并不需要它，选好之后右下角点关闭支付资料。

![有添加过的随便选一个理由后点击关闭支付资料](assets/06-有添加过的随便选一个理由后点击关闭支付资料.png)

关掉之后再回到那个支付资料地址，**已经变成空白页面了**，这就说明账号干净了，可以进入下一步。

![再进去已经是没有支付了](assets/07-再进去已经是没有支付了.png)
...
![购买卡密](assets/08-购买卡密.png)

支付方式选支付宝，直接付款就行。

付完之后页面会跳到订单详情，**在子订单交付那一块能看到一串卡密**，把这串卡密复制下来。

![打开充值网站填写卡密等信息](assets/09-打开充值网站填写卡密等信息.png)
